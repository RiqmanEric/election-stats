...
public class PartyResource {
	...
	public Party getParty(@PathParam("partyname") String partyname) {
		...
		toReturn.setChairPerson(new ChotaPerson("Sonia Gandhi", "1965-5-4"));
		ArrayList<ChotaPerson> notablePerson = new ArrayList<ChotaPerson>();
		notablePerson.add(new ChotaPerson("Sonia Gandhi", "1965-5-4"));
		notablePerson.add(new ChotaPerson("Rahul Gandhi", "1965-5-4"));
		notablePerson.add(new ChotaPerson("Manmohan Singh", "1965-5-4"));
